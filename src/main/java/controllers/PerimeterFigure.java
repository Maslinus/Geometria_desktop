...
public class PerimeterFigure {
    ...
    public void onCountButtonClick(ActionEvent actionEvent) {
        try {
            ...
            label.setText("Периметр:");
            infoField.setText(HelloApplication.getInstance().getAppModel().figures.get(selectedIndex).length() + "");
            ...
            alert.setContentText("Подсчёт периметра фигуры успешно завершен");
            alert.showAndWait();
        }
        catch (Exception e) {
